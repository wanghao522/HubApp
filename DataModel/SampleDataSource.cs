...
namespace Hub.Data
{
    ...
    {
        public SampleDataGroup(String uniqueId, String title, String subtitle, String imagePath, String imageGenderPath,String description)
        {
            this.UniqueId = uniqueId;
            this.Title = title;
            this.Subtitle = subtitle;
            this.Description = description;
            this.ImagePath = imagePath;
            this.ImageGenderPath = imageGenderPath;
        ...
        public string Description { get; private set; }
        public string ImagePath { get; private set; }
        public string ImageGenderPath { get; private set; }
    ...
    public sealed class SampleDataSource
    {
        ...
        private async Task GetSampleDataAsync()
        {
            ...
            using (StreamReader streamReader = new StreamReader(accessStream.AsStreamForRead((int)accessStream.Size)))
            {
                ...
                //Encoding.UTF8.GetString(jsonText.ToArray<byte>(),0,jsonText.Count());
            }
